...
/*Garfield: */
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (12, "Kater", 1, 1, "Orange", "Garfield siehtgenau so aus wie der berÃ¼hmte Kater aus dem Comic, under isst genauso gerne (auch Lasagne). Er ist etwas schwierig,doch mit Zeit und Liebe wird er immer zutraulicher. Er wartetnur noch auf 'SEINE' Familie.", "Männlich", "Garfield", 0, 2);
/*Mogli: */
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (2, "Kater", 1, 1, "Schwarz", "Mogli ist ein kleines Glückskind. Er wurde mitten auf der Autobahn gefunden und zu unsgebracht. Nach ersten Checks und der Erstbehandlungwurde er von uns liebevoll aufgezogen. Damit sein Glück perfekt wird fehlt nur noch eine liebevolle Familie.", "Männlich", "Mogli", 0, 2);
/*Carlos: */
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (3, "Papagei", 0, 1, "Blau, Gelb","Carlos ist ein Papagei, der uns zugeflogen ist. Er versteht sich mit allen Tieren, Kinder mag er nicht besonders gerne.", "Männlich", "Carlos", 0, 3);
/*Wilma: */
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (2, "Katze", 1, 1, "Getigert", "Wilma ist eine Katze, welche immer auf der Suche nach NÃ¤he zu 'ihrer' Familie ist. Sie wartet auf den perfekten Platz für immer.", "Weiblich", "Wilma", 0, 2);
/*Banja: */
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (6, "Westie", 0, 0, "WeiÃŸ", "Banja ist eine sehr verspielte Westie-Dame, welche ebenso verschmust wie aufgeweckt ist.Sie liebt Spaziergänge über alles, doch sie würde auch stundenlange Streicheleinheiten über sich ergehen lassen.", "Weiblich", "Banja", 0, 1);
/*Cookie: */
...
/*Aramis: */ 
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (6, "Kleinspitz", 0, 0, "Schwarz", "Aramis ist ein Kleinspitz, der sich gerne mit Menschen und Tieren jeglicher Art beschÃ¤ftigt. Er liebt jede Art von Beschäftigung, kann sichaber auch gut selbst beschäftigen.", "Männlich", "Aramis", 0, 1);
/*Mailo: */
...
/*Hugo: */
INSERT INTO animals (age, breed, castrated, chipped, color, description, gender, name, version, species_id) VALUES (3, "Waschbär", 0, 1, "Schwarz, Grau, Weiß","Hugo ist der wohl zutraulichste Waschbär, den man sich vorstellen kann. Er ist auf der Suche nach einer neuen Familie.", "Männlich", "Hugo", 0, 3);
